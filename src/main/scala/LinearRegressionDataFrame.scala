...
object LinearRegressionDataFrame {
  ...
  def main(args: Array[String]) {
    ...
    val inputLines = spark
      .sparkContext
      .textFile("src/main/resources/RDDFiles/regression.txt")

    val data = inputLines
      .map(_.split(","))
      //hard way of creating labelled points since using dataframes
    ...
    // to get your data. Or json!

    // Let's split our data into training data and testing data, sweet!

...
object LinearRegressionRDD {
  ...
  def main(args: Array[String]) {
    ...
    val trainingLines = sc.textFile("src/main/resources/RDDFiles/regression.txt")
    ...
    val testingLines = sc.textFile("src/main/resources/RDDFiles/regression.txt")
    ...
    val predictionAndLabel = predictions
